...
set SRC_DIR=C:\Users\ira34\source\repos\LAVI\project\application\externals\llama.cpp

set COMMON_OPTS=-G Ninja -DGGML_CUDA=ON -DCUDAToolkit_ROOT="%CUDA_PATH%" -DCMAKE_CUDA_COMPILER="%CUDA_PATH%\bin\nvcc.exe" -DBUILD_SHARED_LIBS=OFF -DLLAMA_BUILD_COMMON=OFF -DLLAMA_BUILD_EXAMPLES=OFF -DLLAMA_BUILD_TESTS=OFF -DLLAMA_BUILD_SERVER=OFF -DLLAMA_BUILD_APP=OFF -DLLAMA_BUILD_TOOLS=OFF -DCMAKE_POLICY_DEFAULT_CMP0091=NEW
